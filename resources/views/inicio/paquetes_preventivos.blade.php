    ...
    <section class="mb-0 p-3 pb-0">
        ...
        <div class="d-flex justify-content-center">
            <div class="col-12 col-md-8 mb-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-sm btn-outline-primary-veris ms-2 px-2 waves-effect flex-grow-1 h-100" type="button" data-bs-toggle="modal" data-bs-target="#modalCategoriaPromociones" style="width: 150px;border-radius: 8px;">
