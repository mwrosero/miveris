        ...
        <div class="row justify-content-center mb-3 pt-3" style="background: #F3F4F5;">
            <ul class="nav nav-pills justify-content-center bg-white w-auto p-1 rounded-3 mb-3" id="pills-tab-page" role="tablist">
                <li class="nav-item" role="presentation" style="width: 150px;">
                    <button data-rel='tienda' class="nav-link page-promociones px-8 px-md-5" id="pills-tienda-tab" data-bs-toggle="pill" data-bs-target="#pills-tienda" type="button" role="tab" aria-controls="pills-tienda" aria-selected="true">Tienda</button>
                </li>
                <li class="nav-item" role="presentation" style="width: 190px;">
                    <button data-rel='mis-paquetes' class="nav-link page-promociones px-8 px-md-5 active" id="pills-mis-paquetes-tab" data-bs-toggle="pill" data-bs-target="#pills-mis-paquetes" type="button" role="tab" aria-controls="pills-mis-paquetes" aria-selected="false">Mis paquetes</button>
                </li>
            </ul>
        </div>
        <div class="row justify-content-center square-pills">
...
<style>
    ...
    .square-pills .nav-pills .nav-link.active, .nav-pills .nav-link.active:hover, .nav-pills .nav-link.active:focus {
