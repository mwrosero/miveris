            ...
            <div class="container-fluid align-items-center px-3 px-lg-5">
                ...
                <!-- <ul class="nav nav-pills">
                    <a class="navbar-brand d-none d-lg-block" href="#">
                        <img src="{{ asset('assets/external/phantomx/img/logo/veris.svg')}}" alt="Logo" width="64" class="">
                    </a>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle menu-link" href="#!" data-bs-toggle="dropdown">Laboratorio</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle menu-link" href="#!" data-bs-toggle="dropdown">La Y</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#!">opcion 1</a></li>
                            <li><a class="dropdown-item" href="#!">opcion 2</a></li>
                        </ul>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle menu-link" href="#!" data-bs-toggle="dropdown">Kpacheco </a>
