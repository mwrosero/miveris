                        ...
                        <div class="card bg-transparent shadow-none">
                            <div class="card-body">
                                <div class="text-center">
                                    <h5>No tienes recetas</h5>
                                    <p>En esta sección podrás revisar tus recetas</p>
                                    <div class="avatar avatar-xxl-10 mx-auto">
                                        <span class="avatar-initial rounded-circle bg-light-grayish-blue">
                                            <img src="{{ asset('assets/img/svg/receta.svg') }}" alt="recetas" class="rounded-circle">
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 d-flex justify-content-center d-none" id="mensajeNoTienesImagenesProcedimientosRealizados">
                        <div class="card bg-transparent shadow-none">
                            <div class="card-body">
                                <div class="text-center">
                                    <h5>No tienes recetas</h5>
                                    <p>En esta sección podrás revisar tus recetas realizadas</p>
                                    <div class="avatar avatar-xxl-10 mx-auto">
                                        <span class="avatar-initial rounded-circle bg-light-grayish-blue">
                                            <img src="{{ asset('assets/img/svg/recetas.svg') }}" alt="muletas" class="rounded-circle">
                                        </span>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", async function () {
        ...
        elemento.innerHTML = "{{ Session::get('userData')->nombre }} {{ Session::get('userData')->primerApellido }}";
