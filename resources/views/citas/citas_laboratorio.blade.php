...
<script>
    ...
    async function consultarDetallesOrdenLaboratorio(){
        ...
        args["endpoint"] = api_url + `/digitales/v1/ordenes/detallesLaboratorio?canalOrigen=${canalOrigen}&idPaciente=${idPaciente}&numeroOrden=${numeroOrden}&codigoEmpresa=${codigoEmpresa}`;
        args["method"] = "GET";
