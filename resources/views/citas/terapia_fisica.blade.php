            ...
            <div class="tab-content bg-transparent" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-pendientes" role="tabpanel" aria-labelledby="pills-pendientes-tab" tabindex="0">
                    <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white py-2 mb-3">
                        <button class="btn btn-sm btn-outline-primary-veris" type="button" data-bs-toggle="offcanvas" data-bs-target="#filtroTerapiaFisica" aria-controls="filtroTerapiaFisica"><i class="bi bi-sliders me-1"></i> Maria Donoso</button>
                    </div>
                    <!-- Card header items -->
                                    ...
                                    <div class="card">
                                        <div class="card-body p-2">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h6 class="text-primary-veris fw-bold mb-0">Terapia física 1 - 2925136</h6>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-2">
                                                <div class="avatar me-2">
                                                    <img src="{{ asset('assets/img/svg/muletas.svg') }}" alt="Avatar" class="rounded-circle bg-light-grayish-blue">
                                                </div>
                                                <div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="card">
                                        <div class="card-body p-2">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h6 class="text-primary-veris fw-bold mb-0">Terapia física 2 - 2925136</h6>
                                                <span class="fs--2 text-lime-veris fw-bold"><i class="bi bi-check2"></i> Atendida</span>
                                            </div>
                                            <p class="fs--2 fw-bold mb-0">Veris - Alborada</p>
                                            <p class="fw-normal fs--2 mb-0">AGO 09, 2022 <b class="fw-normal text-primary-veris">10:20 AM</b></p>
