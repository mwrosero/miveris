...
<div class="flex-grow-1 container-p-y pt-0">
    ...
    <section class="p-3 mb-3">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="fw-medium border-start-veris ps-3 fs-18">{{ __('¿Qué resultados deseas ver?') }}</h5>
        </div>
                    ...
                    <a href="{{route('resultados.laboratorio')}}">
                        <div class="row g-0 justify-content-between align-items-center">
                            ...
                            <div class="col-3 col-md-auto">
                                <img src="{{ asset('assets/img/card/svg/microscopio.svg') }}" class="img-fluid" alt="{{ __('Laboratorio') }}">
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="card mb-3">
                    <a href="{{ route('resultados.ImagenesProcedimientos') }}">
                        <div class="row g-0 justify-content-between align-items-center">
                            ...
                            <div class="col-3 col-md-auto">
                                <img src="{{ asset('assets/img/card/svg/imagen.svg') }}" class="img-fluid" alt="{{ __('Imágenes y procedimientos') }}">
                            </div>
                        </div>
                    </a>
                </div>
