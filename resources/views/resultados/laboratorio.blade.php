                    ...
                    <div class="col-12 col-md-6">
                        <div class="card h-100">
                            <div class="card-body p-3">
                                <h6 class="text-primary-veris fw-bold fs--1 mb-1">Laboratorio</h6>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div class="avatar me-2">
                                        <img src="{{ asset('assets/img/svg/microscopio.svg') }}" alt="Avatar" class="rounded-circle border" style="background: #F1F8E2;">
                                    </div>
                                    <button type="button" class="btn btn-sm btn-primary-veris" data-bs-toggle="modal" data-bs-target="#resultadoLaboratorioModal">
                                        Ver resultados
                                    </button>
                                </div>
                            </div>
