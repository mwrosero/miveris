...
<div class="flex-grow-1 container-p-y pt-0">
    ...
    <div class="tab-content bg-transparent px-0 py-0 mb-4">
        <!-- filtro -->
                        ...
                        elemento += `<div class="col-12 col-md-6">
                                        <div class="card h-100">
                                            <div class="card-body p--2">
                                                ...
                                                <p class="text-one-line fw-medium fs--2 line-height-16 mb-1" id="nombreResultadoLab" style="color: #0055AA !important">${capitalizarElemento(resultados.nombreOrigenResultado)}</p>
