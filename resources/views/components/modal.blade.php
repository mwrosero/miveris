    ...
    <div class="modal-dialog modal-alert-component modal-dialog-centered mx-auto" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mx-auto title-section fw-medium" id="modalAlertTitle">{{ $title }}</h5>
            </div>
            <div class="modal-body text-center fs-14 mb-2" id="modalAlertMessage">
                {{ $message }}
            </div>
            <div class="modal-footer">
                <button type="button" class="btn w-50 m-0 fw-medium shadow-none border-0 d-none" data-bs-dismiss="modal" id="modalAlertButtonCancelar">Cancelar</button>
                <a href="#" type="button" class="btn bg-veris w-50 m-0 fw-medium d-none" id="modalAlertButtonAccion"></a>
