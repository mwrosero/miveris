<nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme-veris px-3" id="layout-navbar">
        ...
        <ul class="navbar-nav flex-row align-items-center">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item fs--1" href="#">
                    ...
                    <li>
                        <a class="dropdown-item fs--1" data-bs-toggle="modal" data-bs-target="#exampleModal">
